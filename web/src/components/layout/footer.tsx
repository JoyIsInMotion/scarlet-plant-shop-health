        ...
        <div className="grid grid-cols-1 gap-10 py-14 sm:grid-cols-4">
          ...
          <div className="sm:col-span-2">
            <Link href="/" className="mb-5 flex items-center gap-2.5">
              ...
              <span className="font-display bg-[linear-gradient(135deg,var(--ribbon-light)_0%,var(--ribbon)_45%,var(--ribbon-dark)_100%)] bg-clip-text text-xl font-bold tracking-tight text-transparent">Скарлет</span>
            </Link>
