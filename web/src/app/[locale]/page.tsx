...
function LandingContent() {
  ...
  const shopCategories = [
    { value: 'bouquet',      label: t('shop.category.bouquet'),      image: '/images/category-bouquet.jpg' },
    { value: 'potted_plant', label: t('shop.category.potted_plant'), image: '/images/category-potted-plant.jpg' },
    { value: 'succulent',    label: t('shop.category.succulent'),    image: '/images/category-succulent.jpg' },
    { value: 'tropical',     label: t('shop.category.tropical'),     image: '/images/category-tropical.jpg' },
    { value: 'seasonal',     label: t('shop.category.seasonal'),     image: '/images/category-seasonal.jpg' },
    { value: 'accessories',  label: t('shop.category.accessories'),  image: '/images/category-accessories.jpg' },
  ];
