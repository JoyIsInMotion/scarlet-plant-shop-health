...
const bg = {
  ...
  plants: {
    ...
    lastWateredOptional: 'Незадължително',
    ...
    addPlant: 'Добавяне на растение',
    namePlaceholder: 'напр. Моят кактус',
    plantName: 'Име на растението',
    saveToCollection: 'Запази в моите растения',
    saveFailed: 'Неуспешно добавяне на растение. Опитайте отново.',
    viewPlant: 'Виж растението →',
    uploadingPhoto: 'Качване на снимка...',
    photo: 'Снимка',
    photoHint: 'Снимай или избери от галерия. AI ще разпознае вида автоматично.',
    takePhoto: 'Снимай',
    choosePhoto: 'Галерия',
    identifyingSpecies: 'Разпознаване на вид...',
    speciesIdentified: '🌿 Мислим, че това е',
    speciesNotInDb: '🌿 Прилича на',
    speciesNotInDbHint: 'Видът не е в каталога ни. Можете да свържете вид по-късно.',
    speciesNotIdentified: 'Не разпознахме вида. Можете да го свържете ръчно.',
    confirmSpecies: 'Да, правилно',
    rejectSpecies: 'Не е правилно',
    speciesConfirmedLabel: 'Видът е потвърден',
    careScheduleHint: 'График за грижи ще се генерира автоматично.',
    species: 'Вид',
    searchSpecies: 'Търси вид...',
    editPlant: 'Редактиране',
    deletePlant: 'Изтриване',
    deleteConfirm: 'Изтриете ли растението? Действието е необратимо.',
    deleteSuccess: 'Растението е изтрито.',
    deleteFailed: 'Неуспешно изтриване. Опитайте отново.',
    saveChanges: 'Запази промените',
    editFailed: 'Неуспешно запазване. Опитайте отново.',
    searchPlants: 'Търси по име или вид...',
    noResults: 'Няма намерени растения.',
  },
  ai: {
...
const en: Dict = {
  ...
  plants: {
    ...
    addPlant: 'Add plant',
    namePlaceholder: 'e.g. My cactus',
    plantName: 'Plant name',
    saveToCollection: 'Save to my plants',
    saveFailed: 'Could not save plant. Please try again.',
    viewPlant: 'View plant →',
    uploadingPhoto: 'Uploading photo...',
    photo: 'Photo',
    photoHint: 'Take or pick a photo. AI will identify the species automatically.',
    takePhoto: 'Camera',
    choosePhoto: 'Gallery',
    identifyingSpecies: 'Identifying species...',
    speciesIdentified: '🌿 We think this is',
    speciesNotInDb: '🌿 Looks like',
    speciesNotInDbHint: "This species isn't in our catalog yet. You can link one later.",
    speciesNotIdentified: "Couldn't identify the species. You can link it manually.",
    confirmSpecies: "Yes, that's correct",
    rejectSpecies: 'Not this one',
    speciesConfirmedLabel: 'Species confirmed',
    careScheduleHint: 'A care schedule will be auto-generated from our database.',
    species: 'Species',
    searchSpecies: 'Search species...',
    editPlant: 'Edit plant',
    deletePlant: 'Delete plant',
    deleteConfirm: 'Delete this plant? This cannot be undone.',
    deleteSuccess: 'Plant deleted.',
    deleteFailed: 'Could not delete plant. Try again.',
    saveChanges: 'Save changes',
    editFailed: 'Could not save changes. Try again.',
    searchPlants: 'Search by name or species...',
